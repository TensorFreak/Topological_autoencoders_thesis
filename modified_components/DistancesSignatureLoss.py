...
class DistancesSignatureLoss(torch.nn.Module):
    ...
    def __init__(self, p=2, normalise=True, dimensions=0):
        ...
        print('Signature loss with pairwise distances')
    ...
    def forward(self, X, Y):
        ...
        X: Tuple[torch.tensor, PersistenceInformation]
            A tuple consisting of the point cloud DISTANCES and the persistence
        ...
        torch.tensor
            ...
            data sets.
        """
        X_pairwise_dist, X_persistence_info = X
        Y_pairwise_dist, Y_persistence_info = Y
